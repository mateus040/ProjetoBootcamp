...
export default function Quiz() {
  return (
    <div className="py-6 px-8 md:px-0 mt-16 md:mt-0 mb-16 md:mb-0">
          ...
          <div className="w-full md:w-[650px] bg-white p-6 rounded-xl text-black">
            ...
            <div className="space-y-5 mt-5">
              ...
              <div className="flex items-center justify-between">
                <Link to="/" className="w-[150px] py-2 rounded-lg bg-transparent hover:bg-zinc-800 border-2 border-black hover:border-zinc-800 text-center uppercase font-bold hover:text-white transition-colors duration-150">
                  Voltar
                </Link>
                <button className="w-[150px] py-2 rounded-lg bg-transparent hover:bg-[#ff0b0b] border-2 border-black hover:border-[#ff0b0b] text-center uppercase font-bold hover:text-white transition-colors duration-150">
                  Verificar
                </button>
              </div>
            </div>
